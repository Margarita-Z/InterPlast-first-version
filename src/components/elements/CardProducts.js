 ...
 <nav>
      <ul className='pagination'>
        <li className='page-item'>
          <a href='#' className='page-link' onClick={prePage}><i className="fa-solid fa-backward"></i></a>
        </li>
        {
          numbers.map((n, i) => (
         ...
         <li className='page-item'>
          <a href='#' className='page-link' onClick={nextPage}><i className="fa-solid fa-forward"></i></a>
        </li>
      </ul>
    </nav>
 </>
